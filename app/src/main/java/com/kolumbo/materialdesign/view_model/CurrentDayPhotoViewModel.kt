...
class CurrentDayPhotoViewModel(
    ...
    fun getData(days: Days): LiveData<PictureOfTheDayData> {
        sendServerRequest(convertDateToString(days).also { Log.d("QWE", "getData: $it") })
    ...
    private fun sendServerRequest(days: String) {
        ...
        val apiKey = "skdepLoLMZoxyUwSO76oz7GOLqtPbZNz6QFokCZN"
        if (apiKey.isBlank()) {
    ...
    private fun convertDateToString(days: Days): String {
